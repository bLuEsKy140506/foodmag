...
const initialState = [
  {
    id: "Sample-1",
    title: "Grilled Corn with Flavored Butters",
    author: "Amanda Neal",
    text: "Buttery grilled corn is one of our favorite summer dinner staples. It’s even better with a trio of seasoned butters—think Cajun, miso and green goddess—served in shallow bowls so everyone at the table can roll an ear in their favorite flavor. Make the butters ahead of time, then pull them out of the refrigerator right before serving.",
    level: "Medium",
    prepTime: 40,
    ...
    ingredient: [
      {
        name: "2 sticks (1 cup), at room temperature",
        quantity: "1½ pounds",
      },
      {
        name: "paprika",
      ...
      {
        name: "Miso butter, unsalted at room temperature",
        quantity: "2 sticks (1 cup)",
      },
    ],
    direction: [
    ...
    imageUrl:
      "https://food.fnr.sndimg.com/content/dam/images/food/fullset/2023/5/16/fnk_GRILLED_CORN_AND_THREE_FLAVORED_BUTTER_BOARD_s4x3.jpg.rend.hgtvcom.826.620.suffix/1684262642622.jpeg",
  },
  {
    id: "sample-2",
    title: "Ala-Earl-updated-online",
    author: "Earl Lauriece S. Butlays",
    text: "Fresh, juicy tomatoes are the star of this classic salad. Just four ingredients and you have the perfect appetizer for your next gathering. Top with basil and drizzle with olive oil to bring it all together.",
    level: "Hard",
    prepTime: 15,
    ...
    ingredient: [
      {
        name: "vine-ripened tomatoes, cored",
        quantity: "1½ pounds",
      },
      {
      ...
      {
        name: "fine sea salt or fleur de sel",
        quantity: "3/4 to 1",
      },
      {
      ...
      {
        name: "basil leaves, torn or cut into thin strips",
        quantity: "1/3 cup packed basil leaves",
      },
      {
    ...
    imageUrl:
      "https://food.fnr.sndimg.com/content/dam/images/food/fullset/2013/10/7/0/FNK_Caprese-Salad_s4x3.jpg.rend.hgtvcom.826.620.suffix/1383814461170.jpeg",
  },
  {
    id: "sample3",
    title: "Caprese Salad",
  ...
  },
  {
    ...
    text: "Marc says, This is a great basic marinade for grilling meats, and the pink peppercorns add a nice spicy kick",
    level: "Hard",
    prepTime: "8 hrs and 30 ",
    yield: "4 serving",
    time: "2023-07-27",
    ingredient: [
      {
        name: "fresh parsley leaves, chopped",
        quantity: "2 cups",
      },
      {
        name: "fresh thyme, chopped",
        quantity: "8 large sprigs",
      },
      {
        name: "fresh rosemary, chopped",
        quantity: "4 large sprigs",
      },
      {
        name: "garlic, minced",
        quantity: "3 cloves",
    ...
    imageUrl:
      "https://food.fnr.sndimg.com/content/dam/images/food/fullset/2012/5/18/1/ES-Forgione_marinated-chicken-thighs_s4x3.jpg.rend.hgtvcom.826.620.suffix/1371609085893.jpeg",
  },
];
